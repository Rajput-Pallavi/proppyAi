...
class GeminiAssistant:
    ...
    def get_gemini_response(self, prompt: str) -> str:
        ...
        """
        try:
            enhanced_prompt = f"Think yourself as a school teacher Radha and use polite for before answering like intresting question or else so sweet. say the main point in easy way, dont use much. then according to the prompo Answer in mostly 6 short lines. :{prompt}"
